...
const IoniconsHeaderButton = (passMeFurther: any) => (
  ...
  <HeaderButton {...passMeFurther} IconComponent={Ionicons} iconSize={40} color={Colors.primary} buttonStyle={{
      ...
      navigationOptions: ({ navigation }: { navigation: any }) => ({
        ...
        headerRight: (
          <HeaderButtons HeaderButtonComponent={IoniconsHeaderButton}>
            <HeaderButton title="MessagesIcon" iconName="ios-chatbubbles" onPress={() => navigation.push('MessageContacts')} />
          </HeaderButtons>
        ),
        ...
        headerLeft: (
          <HeaderButtons HeaderButtonComponent={IoniconsHeaderButton}>
            <HeaderButton title="ProfileIcon" iconName="ios-person" onPress={() => navigation.push('ProfileScreen')} />
          </HeaderButtons>
        ),
        headerTitleStyle: {
          textAlign: 'center',
