...
<ScrollView>
        <TouchableHighlight style={styles.messageButton} underlayColor="orange"  onPress={this._handleMessagePress}>
            <View style={styles.row}>
                <Image source={picThuy} style={{width: 80, height: 80, borderRadius: 40}}/>
              ...
              <TouchableHighlight style={styles.messageButton} underlayColor="orange"  onPress={this._handleMessagePress}>
            <View style={styles.row}>
                <Image source={picShaggy} style={{width: 80, height: 80, borderRadius: 40}}/>
                <View style={styles.imageHolder}>
            ...
            <TouchableHighlight style={styles.messageButton} underlayColor="orange"  onPress={this._handleMessagePress}>
            <View style={styles.row}>
                <Image source={picDaphne} style={{width: 80, height: 80, borderRadius: 40}}/>
                <View style={styles.imageHolder}>
             ...
             <TouchableHighlight style={styles.messageButton} underlayColor="orange"  onPress={this._handleMessagePress}>
            <View style={styles.row}>
                <Image source={picFred} style={{width: 80, height: 80, borderRadius: 40}}/>
                <View style={styles.imageHolder}>
                  <Text style={styles.name}>Fred</Text> 
                  <Text>I want to schedule a regular rideshare if that's okay with you?</Text>
                </View>
            </View>
        </TouchableHighlight>
            ...
            <TouchableHighlight style={styles.messageButton} underlayColor="orange"  onPress={this._handleMessagePress}>
            <View style={styles.row}>
                <Image source={picVelma} style={{width: 80, height: 80, borderRadius: 40}}/>
                <View style={styles.imageHolder}>
          ...
          <TouchableHighlight style={styles.messageButton} underlayColor="orange"  onPress={this._handleMessagePress}>
            <View style={styles.row}>
                <Image source={picScooby} style={{width: 80, height: 80, borderRadius: 40}}/>
                <View style={styles.imageHolder}>
            ...
            <TouchableHighlight style={styles.messageButton} underlayColor="orange"  onPress={this._handleMessagePress}>
            <View style={styles.row}>
                <Image source={picStGermain} style={{width: 80, height: 80, borderRadius: 40}}/>
                <View style={styles.imageHolder}>
                  <Text style={styles.name}>St. Germain</Text> 
                     ...
                     <TouchableHighlight style={styles.messageButton} underlayColor="orange"  onPress={this._handleMessagePress}>
            <View style={styles.row}>
                <Image source={picSmiley} style={{width: 80, height: 80, borderRadius: 40}}/>
                <View style={styles.imageHolder}>
